...
export const useAppStoreComplete = (): AppContextType => {
    ...
    const { handleTerraformPress, isNewSessionModalOpen, ...rest } = pilot;
    return { ...dummy, ...rest, handleTerraformPress, isNewSessionModalOpen } as AppContextType;
}